These documentation files can be large and contain overwhelming info. I advise using a subagent to prevent polluting your context when looking for info.    
...
- `pub closed spec fn well_formed(&self) -> bool` is useful

Example producer consumer queue verification walkthrough
/home/mod/Documents/github/verus-tock/verus/source/docs/state_machines/src/examples/producer-consumer-queue.md
And the two .rs files in this folder provide code reference.
